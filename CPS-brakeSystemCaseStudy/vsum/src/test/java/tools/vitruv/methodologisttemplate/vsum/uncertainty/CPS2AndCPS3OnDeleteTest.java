...
public class CPS2AndCPS3OnDeleteTest {

        private static final Logger logger = org.slf4j.LoggerFactory
                        .getLogger(CPS2AndCPS3OnDeleteTest.class);
        ...
        void cps2onDeleteNoActionTest(@TempDir Path tempDir) {
        ...
        void cps3onDeleteRestrictTest(@TempDir Path tempDir) {
