...
public class CPS5UncertaintyConsistencyTest {
	/*
	This test class shows using a simplified CPS-brakesystem example
	that uncertainties are kept consistent automatically across models. 
	Any chosen test corresponds to CPS-5 (not alltogether, as they are conceptually the same)
	 */

	private static final Logger logger = org.slf4j.LoggerFactory
			.getLogger(CPS5UncertaintyConsistencyTest.class);
