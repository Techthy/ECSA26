...
public class CPS7BrakeDiskDiameterUncertaintyTest {
	private static final Logger logger = org.slf4j.LoggerFactory
			.getLogger(CPS7BrakeDiskDiameterUncertaintyTest.class);
	...
	// CPS-7 Resolve the uncertainty domain-specifically as specified in the respective Reaction.
	@Test
